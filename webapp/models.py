...
class CustomerDetails(models.Model):
    ...
    national_id_type = models.CharField(
        max_length=50, choices=NATIONAL_ID_TYPE)
    national_id = models.CharField(max_length=50)
    username = models.CharField(max_length=20, null=True, blank=True)
    password = models.CharField(max_length=20, null=True, blank=True)
    registration_status = models.CharField(
        max_length=50, choices=REGISTRATION_STATUS, default='Pending')
...
class CustomerReservations(models.Model):
    ...
    facility = models.ForeignKey(
        Facilities, on_delete=models.CASCADE, null=True)
...
class CustomerFacility(models.Model):
    customer = models.ForeignKey(
        CustomerDetails, on_delete=models.CASCADE, null=True, blank=True)
    facility = models.ForeignKey(
        Facilities, on_delete=models.CASCADE, null=True, blank=True)
