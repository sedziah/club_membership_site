...
def update_customer_facility(customer_id, facility_name):
    ...
    customer_facility = CustomerFacility.objects.create(
        customer=customer_instance, facility=facility_instance)
...
def customer_percentage_paid(customer_id, subscription_cost=1000):
    ...
    customer_payments = CustomerPayments.objects.filter(
